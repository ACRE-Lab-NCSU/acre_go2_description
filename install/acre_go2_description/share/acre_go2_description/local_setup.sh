...
: ${AMENT_CURRENT_PREFIX:="/workspace/install/acre_go2_description"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/acre_go2_description/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/acre_go2_description/environment/path.sh"
